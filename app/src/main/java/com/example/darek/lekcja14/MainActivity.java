package com.example.darek.lekcja14;
...
public class MainActivity extends Activity {
    ...
    protected void playMusic(){
        ...
        try {
            ...
            DownloadFilesTask downloadFilesTask = new  DownloadFilesTask(mPlayer, seekBar);
...
class DownloadFilesTask extends AsyncTask<Void, Void, Void> {
    ...
    DownloadFilesTask(MediaPlayer player, SeekBar bar) {
        this.player = player;
        this.bar = bar;
    }
